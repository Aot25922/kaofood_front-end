    ...
    <div class="max-w-md mx-auto bg-white p-3 rounded">
      ...
      <div v-if="mode == 'SignUp'" class="w-full p-3 px-6 py-10">
        ...
        <div class="mt-3 relative">
          ...
          <input
            ...
            "
          />
          <span v-if="emptyFirstName" class="text-error"
        ...
        <div class="mt-4 relative">
          ...
          <span v-if="accountPhoneExist" class="text-error"
            >Phone already exist!</span
          >
        </div>
        <div class="mt-4 relative">
          <span class="absolute p-1 bottom-8 ml-2 bg-white text-gray-400"
          ...
          <span v-if="accountEmailExist" class="text-error"
      ...
      <div v-else class="px-3 py-5">
        ...
        <div class="relative mb-3">
          ...
          />
          <span v-if="emptyEmail" class="text-error"
        ...
        <div class="relative mb-1">
          ...
          <input
            ...
            class="transition duration-500 border h-12 rounded w-full px-2 mb-2"
          />
          <span v-if="emptyPassword" class="text-error"
        ...
        <div class="flex flex-row mb-3">
          <a
            href="#"
            class="flex-1 cursor-pointer text-blue-500 hover:text-blue-700"
            >Forgot password?</a
          >
          <router-link
            class="flex-none text-neutral-focus underline"
            to="/signup"
            >Sign Up</router-link
          >
        </div>
