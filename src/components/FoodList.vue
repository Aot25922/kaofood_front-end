<template>
  <div id="FoodList" class="card bordered bg-white">
    ...
    <div class="card-body xl:p-8 lg:p-5 p-3">
      ...
      <router-link class="text-gray-dark lg:text-base md:text-sm text-xs text-right" :to="{ name:'MenuInfo' , params: { id : menu.id } }">More Info...</router-link>
      <div v-if="account!=null&&account.role=='Admin'" class="flex flex-row card-actions">
